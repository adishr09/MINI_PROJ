...
$q =" INSERT INTO `delhibvce`.`art_mailer` (`mail_id`, `aut_id`, `full_name`, `email_id`, `filename`, `contact_no`, `sub_cat`, `paper_type`, `abstract`) VALUES (NULL, '".$auth_id."', '".$name."', '".$email."', '".$file."', '".$contact."', '".$cat."', '".$paper_tag."', '".$abst."');";
    echo $q;
